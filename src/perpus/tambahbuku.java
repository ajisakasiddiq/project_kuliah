...
String filename;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 380, -1, -1));

        txt_deskripsi.setBackground(new java.awt.Color(255, 255, 255));
        txt_deskripsi.setPreferredSize(new java.awt.Dimension(480, 31));
        txt_deskripsi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_deskripsiActionPerformed(evt);
            }
        });
        jPanel1.add(txt_deskripsi, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 460, -1));

        txt_penerbit.setBackground(new java.awt.Color(255, 255, 255));
        txt_penerbit.setPreferredSize(new java.awt.Dimension(480, 31));
        txt_penerbit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_penerbitActionPerformed(evt);
            }
        });
        jPanel1.add(txt_penerbit, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 280, 460, -1));

        txt_stok.setBackground(new java.awt.Color(255, 255, 255));
        txt_stok.setPreferredSize(new java.awt.Dimension(480, 31));
        txt_stok.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_stokActionPerformed(evt);
            }
        });
        jPanel1.add(txt_stok, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 460, -1));
        ...
        jPanel1.add(txt_kodebuku, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, 460, -1));

        txt_image.setBackground(new java.awt.Color(255, 255, 255));
        txt_image.setPreferredSize(new java.awt.Dimension(480, 31));
        txt_image.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_imageActionPerformed(evt);
            }
        });
        jPanel1.add(txt_image, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 420, -1));

        txt_penulis.setBackground(new java.awt.Color(255, 255, 255));
        txt_penulis.setPreferredSize(new java.awt.Dimension(480, 31));
        txt_penulis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_penulisActionPerformed(evt);
            }
        });
        jPanel1.add(txt_penulis, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, 460, -1));
        ...
        jPanel1.add(txt_judul, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 80, 460, -1));

        jLabel11.setBackground(new java.awt.Color(255, 255, 255));
        jLabel11.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("TAMBAH BUKU");
        ...
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 330, -1, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 20, -1, 30));
        ...
        btn_simpan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foto/simpan-removebg-preview (3).png"))); // NOI18N
        jPanel1.add(btn_simpan1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 420, -1, -1));

        btn_upload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foto/upload.png"))); // NOI18N
        btn_upload.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_uploadMouseClicked(evt);
            }
        });
        jPanel1.add(btn_upload, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 230, -1, 30));
   ...
   JOptionPane.showMessageDialog(null, "Gagal Upload Gambar :( ");
   }
